...
export function AccountDataMap({ client }: AccountDataMapProps) {
  const meta = client.metadata || {};

  // Build lookup: field → value (check both metadata and top-level client fields)
  ...
  // Unique sources present for this client
  const sourcesPresent = new Set(
    available.map((f) => f.source)
  );
